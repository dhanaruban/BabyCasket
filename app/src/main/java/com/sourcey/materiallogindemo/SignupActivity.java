...
public class SignupActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        EditText mobileText =(EditText)findViewById(R.id.input_mobile);
        EditText passwordText =(EditText)findViewById(R.id.input_reEnterPassword);
        EditText reEnterPasswordText =(EditText)findViewById(R.id.input_name);
